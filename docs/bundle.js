...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "date svelte-1va3ebz");
    			add_location(div0, file, 123, 0, 2595);
    			attr_dev(div1, "class", "date-picker svelte-1va3ebz");
    			add_location(div1, file, 124, 2, 2692);
    			attr_dev(button, "class", "reset svelte-1va3ebz");
    			add_location(button, file, 129, 0, 3032);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$1, 82, 5, 2228);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(82:3) {#each data as item }", ctx });
    	return block;
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 80, 2, 2166);
    			attr_dev(div, "class", "year");
    			add_location(div, file$1, 79, 0, 2089);
  ...
  `;
      ...
      let onMouseUp = () => {
    	...
    	const writable_props = ['selected', 'data'];
    	...
    	$$self.$capture_state = () => {
    		return { selected, data, position, offset, dragging, itemWrapper, previousY, itemPosition, onMouseDown, onMouseMove, onMouseUp };
    	};
    ...
    class ItemWheel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, ["selected", "data"]);
