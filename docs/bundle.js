...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = /*MONTHS*/ ctx[5][/*date*/ ctx[0].getMonth()] + "";
    	let t2;
    	let t3;
    	...
    	let t5;
    	let p;
    	let t6_value = /*WEEKDAY*/ ctx[7][/*date*/ ctx[0].getDay()] + "";
    	let t6;
    	let t7;
    	let div1;
    	let t8;
    	...
    	switcher0.$on("dateChange", /*dateChanged*/ ctx[9]);
    	...
    	switcher1.$on("dateChange", /*dateChanged*/ ctx[9]);
    	...
    	switcher2.$on("dateChange", /*dateChanged*/ ctx[9]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "date-line svelte-1uzg16n");
    			add_location(div0, file$1, 114, 8, 3095);
    			attr_dev(p, "class", "day-line svelte-1uzg16n");
    			add_location(p, file$1, 115, 8, 3203);
    			attr_dev(div1, "class", "touch-date-picker svelte-1uzg16n");
    			add_location(div1, file$1, 116, 8, 3263);
    			attr_dev(button0, "class", "svelte-1uzg16n");
    			add_location(button0, file$1, 122, 10, 3679);
    			attr_dev(button1, "class", "svelte-1uzg16n");
    			add_location(button1, file$1, 123, 10, 3734);
    			attr_dev(div2, "class", "touch-date-reset svelte-1uzg16n");
    			add_location(div2, file$1, 121, 8, 3637);
    			attr_dev(div3, "class", "touch-date-wrapper svelte-1uzg16n");
    			add_location(div3, file$1, 113, 6, 3053);
    			attr_dev(div4, "class", "svelte-1uzg16n");
    			add_location(div4, file$1, 112, 4, 3040);
    			attr_dev(div5, "class", "touch-date-popup svelte-1uzg16n");
    			add_location(div5, file$1, 111, 2, 3003);

    			dispose = [
    				listen_dev(button0, "click", /*resetDate*/ ctx[8], false, false, false),
    		...
    		p: function update(ctx, dirty) {
    			...
    			if ((!current || dirty & /*date*/ 1) && t2_value !== (t2_value = /*MONTHS*/ ctx[5][/*date*/ ctx[0].getMonth()] + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*date*/ 1) && t4_value !== (t4_value = /*date*/ ctx[0].getFullYear() + "")) set_data_dev(t4, t4_value);
    			if ((!current || dirty & /*date*/ 1) && t6_value !== (t6_value = /*WEEKDAY*/ ctx[7][/*date*/ ctx[0].getDay()] + "")) set_data_dev(t6, t6_value);
    			const switcher0_changes = {};
    			if (dirty & /*DAYS*/ 16) switcher0_changes.data = /*DAYS*/ ctx[4];
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", input_class_value = "" + (null_to_empty(/*classes*/ ctx[2]) + " svelte-1uzg16n"));
    			input.readOnly = true;
    			input.value = /*_date*/ ctx[3];
    			add_location(input, file$1, 109, 0, 2886);
    			dispose = listen_dev(input, "focus", /*focus_handler*/ ctx[12], false, false, false);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*classes*/ 4 && input_class_value !== (input_class_value = "" + (null_to_empty(/*classes*/ ctx[2]) + " svelte-1uzg16n"))) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("years_map" in $$props) $$invalidate(10, years_map = $$props.years_map);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("resetDate" in $$props) $$invalidate(8, resetDate = $$props.resetDate);
    		if ("dateChanged" in $$props) $$invalidate(9, dateChanged = $$props.dateChanged);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*date*/ 1) {
    			 $$invalidate(4, DAYS = new Array(new Date(date.getFullYear(), date.getMonth() + 1, 0).getDate()).fill(1).map((v, i) => v + i));
    		}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "center svelte-103essu");
    			add_location(div0, file$2, 40, 2, 646);
    			attr_dev(div1, "class", "container svelte-103essu");
