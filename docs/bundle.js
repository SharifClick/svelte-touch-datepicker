...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 108, 0, 2850);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["date", "visible", "years_map"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("years_map" in $$props) $$invalidate(9, years_map = $$props.years_map);
    	};
    ...
    class DatePicker extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { date: 0, visible: 1, years_map: 9 });
