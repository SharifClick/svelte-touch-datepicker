...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 117, 0, 3140);
    			dispose = listen_dev(input, "focus", /*focus_handler*/ ctx[14], false, false, false);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("years_map" in $$props) $$invalidate(11, years_map = $$props.years_map);
